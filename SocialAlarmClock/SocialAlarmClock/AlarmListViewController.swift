...
class AlarmListViewController: UITableViewController {
    ...
    var alarmsData: [alarm] = [alarm(time: "1:30", friends: ["A", "B"]), alarm(time: "2:30", friends: ["C", "D"])]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        super.tableView.registerClass(UITableViewCell.self, forCellReuseIdentifier: "alarmcell")
